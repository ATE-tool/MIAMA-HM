...
readr::write_csv(
  england_lsoa21_syoa_smoothed,
  here::here("health_data/processed/england_lsoa21_mxrates.csv")
)
...
england_lifetable_lad_imd <- england_lsoa21_syoa_smoothed %>%
  dplyr::select(lsoa21cd, LAD22CD, LAD22NM, sex, age, rate1000, imd_decile) %>%
  
  # join population
  left_join(pop21_syoa %>%
              dplyr::select(lsoa21cd, sex = gender, age, population), 
            by = c("lsoa21cd",  "sex", "age")) %>%
